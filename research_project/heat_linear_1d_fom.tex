...
\begin{subequations}
    \begin{align}
        \left.\frac{\partial u}{\partial t}\right|_{x} - \alpha(x) \Delta u &= f(x, t; \mu), \label{eq:1d_fom_strong_pde}\\
        u(0, t) &= b_0(t; \mu), \\
        u(L, t) &= b_L(t; \mu), \\
        u(x, 0) &= u_0(x; \mu),
    \end{align}
...
\begin{equation}
    \left.\frac{\partial u}{\partial t}\right|_{x} - w \pdv{u}{x} - \alpha \Delta u = f
\end{equation}
