...
If the equations are to be solved in the physical domain, we only need to adapt the time derivative in the physical domain $\left.\frac{\partial u}{\partial t}\right|_{x}$.
