...
\mytodo{Relate this "energy" to the actual error made by the POD basis in the reconstruction of the original span.}
...
\begin{table}[h]
    ...
    \end{tabular}
\end{table}
\mytodo{Extend for multiple valuations.}
...
\mytodo{Make this a relative error.}
\begin{equation}
