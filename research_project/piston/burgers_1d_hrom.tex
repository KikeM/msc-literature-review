...
\begin{table}[h]
    \centering
    \caption{Summary table with the included effects for each section.}
    \begin{tabular}{@{}cccc@{}}
    \toprule
...
\clearpage
\subsection{Reduction Results for Non-Uniform Mesh Stretching}
...
Section~\ref{sec:nmdeim_one_mode}, despite the non-uniform spacing of the mesh.
...
The N-(M)DEIM has been assembled with the first five RB solution modes.
