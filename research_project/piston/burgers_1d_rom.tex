...
\begin{subequations}
    ...
    \begin{align}
        ...
        \\[2mm]
        \vb{K}_{N}^{n+1} &= m_{\text{BDF}} \vb{M}^{n+1}_{N} + \dt \left[\vb{A}^{n+1}_{N} + \vb{C}^{n+1}_{N} \right. 
        \nonumber 
        \\
                        &\left. + \vb{\hat{N}}^{n+1}_{N} + \vb{N}^{n+1}_{N}\left(\vb{\hat{u}}_{N}^{*}\right)\right],
        \\[2mm]
...
\end{equation}
that is, the representation of any vector in the original space can be reconstructed by the POD basis, 
...
\begin{subequations}
    ...
    \begin{align}
        ...
        \vb{\hat{u}}_{N}^{0} &= \vb{\hat{u}}_{N,0};
        \\[5mm]
        \vb{K}_{N}^{m, n+1} &= m_{\text{BDF}} \vb{M}^{m, n+1}_{N} + \dt \left[\vb{A}^{m, n+1}_{N} + \vb{C}^{m, n+1}_{N} \right. 
        \nonumber 
        \\
                        &\left. + \vb{\hat{N}}^{m, n+1}_{N} + \vb{N}^{m, n+1}_{N}\left(\vb{\hat{u}}_{N}^{m, *}\right)\right],
        \\[2mm]
