...
\begin{subequations}
    ...
    \begin{align}
        ...
        \\
        \vb{K}_{N}^{n+1} &= m_{\text{BDF}} \Ah{M} + \dt \left[\Ah{A} + \Ah{B} \right. 
        \nonumber 
        \\
...
\mytodo{Create diagram and sketches}
...
\mytodo{Reference from MDEIM paper.}
...
\mytodo{Update equations for piston problem.}
\begin{subequations}
    \label{eq:1d_rom_weak_formulation_discrete}
    \begin{align}
