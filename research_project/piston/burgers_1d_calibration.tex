...
\mytodo{Place holder for stabilization operators.}
\mytodo{Could we reduce other operators?.}
...
\mytodo{Show simulation for constant solution (related to D-GCL).}
...
\mytodo{Present nondimensional results.}
\begin{figure}[h]
    \centering
