...
we are going to develop a ROM formulation which allows us to remain in the physical domain, 
...
\begin{itemize}
    ...
    % and solutions for the moving piston for different parametrizations
    ;
