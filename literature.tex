...
Because the piston problem is defined in a moving domain,
...
there must be a sampling strategy in the parameter space,
...
% POD-based
An alternate approach is to rely on an external methodology
...
The collateral basis is generated with function evaluations following
a greedy procedure 
\cite{Hesthaven2014}.
